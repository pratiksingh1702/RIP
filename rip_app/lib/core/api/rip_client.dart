...
class RipClient {
  ...
  Future<List<Project>> listProjects({CancelToken? cancelToken}) async {
    try {
      ...
      final projects =
          data.map((j) => Project.fromJson(j as Map<String, dynamic>)).toList();
      RipLogger.success('listProjects() returned ${projects.length} projects',
          tag: 'RipClient_Endpoint');
      return projects;
    } catch (e, stack) {
      RipLogger.error('listProjects() failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Project> getProject(String projectId) async {
    try {
      RipLogger.info('Calling getProject(projectId: $projectId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get('/projects/$projectId');
      final project = Project.fromJson(response.data as Map<String, dynamic>);
      RipLogger.success(
          'getProject(projectId: $projectId) succeeded: ${project.projectName}',
          tag: 'RipClient_Endpoint');
      return project;
    } catch (e, stack) {
      RipLogger.error('getProject(projectId: $projectId) failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<void> deleteProject(String projectId) async {
    try {
      ...
      RipLogger.success('deleteProject(projectId: $projectId) succeeded',
          tag: 'RipClient_Endpoint');
    } catch (e, stack) {
      RipLogger.error('deleteProject(projectId: $projectId) failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<IndexJob> startGitIndex({
    ...
    try {
      RipLogger.info(
          'Calling startGitIndex(gitUrl: $gitUrl, projectName: $projectName, folderName: $folderName, subdirectory: $subdirectory, branch: $branch)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.post('/git/index',
          data: {
            'git_url': gitUrl,
      ...
      RipLogger.success(
          'startGitIndex succeeded: job ${job.jobId} state ${job.status}',
          tag: 'RipClient_Endpoint');
      return job;
    } catch (e, stack) {
      RipLogger.error('startGitIndex failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<IndexJob> getJobStatus(String jobId) async {
    try {
      RipLogger.info('Calling getJobStatus(jobId: $jobId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get('/git/status/$jobId');
      final job = IndexJob.fromJson(response.data as Map<String, dynamic>);
      RipLogger.success('getJobStatus(jobId: $jobId) status is ${job.status}',
          tag: 'RipClient_Endpoint');
      return job;
    } catch (e, stack) {
      RipLogger.error('getJobStatus(jobId: $jobId) failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<List<SearchResult>> search({
    ...
    try {
      RipLogger.info(
          'Calling search(projectId: $projectId, query: "$query", limit: $limit)',
          tag: 'RipClient_Endpoint');
      ...
      final list = results
          ...
          .toList();
      RipLogger.success('search returned ${list.length} results',
          tag: 'RipClient_Endpoint');
      return list;
    } catch (e, stack) {
      RipLogger.error('search failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> trace({
    ...
    try {
      RipLogger.info('Calling trace(projectId: $projectId, symbol: "$symbol")',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/trace/$symbol',
      ...
      RipLogger.success('trace succeeded: key count ${result.length}',
          tag: 'RipClient_Endpoint');
      return result;
    } catch (e, stack) {
      RipLogger.error('trace failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> impact({
    ...
    try {
      RipLogger.info('Calling impact(projectId: $projectId, symbol: "$symbol")',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/impact/$symbol',
        queryParameters: {'project_id': projectId},
      ...
      final data = response.data as Map<String, dynamic>;
      final result = data['data'] as Map<String, dynamic>;
      RipLogger.success('impact succeeded: key count ${result.length}',
          tag: 'RipClient_Endpoint');
      return result;
    } catch (e, stack) {
      RipLogger.error('impact failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> architecture({
    ...
    try {
      RipLogger.info('Calling architecture(projectId: $projectId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/architecture',
        queryParameters: {'project_id': projectId},
      ...
      final data = response.data as Map<String, dynamic>;
      final result = data['data'] as Map<String, dynamic>;
      RipLogger.success('architecture succeeded: key count ${result.length}',
          tag: 'RipClient_Endpoint');
      return result;
    } catch (e, stack) {
      RipLogger.error('architecture failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> explain({
    ...
    try {
      RipLogger.info('Calling explain(projectId: $projectId, topic: "$topic")',
          tag: 'RipClient_Endpoint');
      final response = await _dio.post('/explain',
          data: {
            'query': topic,
            'project_id': projectId,
      ...
      final data = response.data as Map<String, dynamic>;
      final result = data['data'] as Map<String, dynamic>? ?? {};
      RipLogger.success('explain succeeded: key count ${result.length}',
          tag: 'RipClient_Endpoint');
      return result;
    } catch (e, stack) {
      RipLogger.error('explain failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> metrics({
    ...
    try {
      RipLogger.info('Calling metrics(projectId: $projectId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/metrics',
        queryParameters: {'project_id': projectId},
      ...
      RipLogger.error('metrics failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> onboard({
    ...
    try {
      RipLogger.info('Calling onboard(projectId: $projectId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/onboard',
        queryParameters: {'project_id': projectId},
      ...
      RipLogger.error('onboard failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> deadCode({
    ...
    try {
      RipLogger.info('Calling deadCode(projectId: $projectId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.get(
        '/dead-code',
        queryParameters: {'project_id': projectId},
      ...
      RipLogger.error('deadCode failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> gatewayContext({
    ...
    try {
      RipLogger.info('Calling gatewayContext(sessionId: $sessionId)',
          tag: 'RipClient_Endpoint');
      final response = await _dio.post('/gateway/api/context',
          data: {
            'task': task,
      ...
      if (response.data is Map) {
        ...
        if (str.startsWith('{')) {
          try {
            data = (jsonDecode(str) as Map).cast<String, dynamic>();
          } catch (_) {
            data = _parseSseContextResponse(str, sessionId);
          }
        } else {
          data = _parseSseContextResponse(str, sessionId);
        }
      ...
      // Handle both wrapped {data: {...}} and direct ContextPackage responses
      final result = (data['data'] is Map)
          ? (data['data'] as Map).cast<String, dynamic>()
          : data;
      // Ensure token_allocation is always a Map
      if (result['token_allocation'] is! Map) {
        result['token_allocation'] = <String, dynamic>{};
      }
      // Ensure context is always a List
      if (result['context'] is! List) {
        result['context'] = <Map<String, dynamic>>[];
      }
      RipLogger.success('gatewayContext succeeded', tag: 'RipClient_Endpoint');
      return result;
    } catch (e, stack) {
      RipLogger.error('gatewayContext failed',
          tag: 'RipClient_Endpoint', error: e, stackTrace: stack);
      rethrow;
    }
  }

  Map<String, dynamic> _parseSseContextResponse(String raw, String fallbackSessionId) {
      ...
      if (trimmed.startsWith('data: ')) {
        ...
        try {
          ...
          if (decoded is Map) {
            ...
            if (map['type'] == 'complete') {
              if (map['session_id'] != null) sessionId = map['session_id'].toString();
              if (map['intent'] != null) intent = map['intent'].toString();
              if (map['tokens_used'] is num) tokensUsed = (map['tokens_used'] as num).toInt();
  ...
  Future<Map<String, dynamic>> gatewayMetrics(
      {CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/api/metrics', cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }

  Future<Map<String, dynamic>> gatewaySources(
      {String? projectId, CancelToken? cancelToken}) async {
    final response = await _dio.get(
      '/gateway/api/sources',
      queryParameters: {
        if (projectId != null) 'project_id': projectId,
  ...
  Future<Map<String, dynamic>> gatewaySourcePresets(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/sources/presets',
        cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }

  Future<Map<String, dynamic>> gatewayOAuthProviders(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/oauth/providers',
        cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> initiateGatewayOAuth(
    ...
    final response = await _dio.post('/gateway/api/oauth/initiate',
        data: values, cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> completeGatewayOAuth(
    ...
    final response = await _dio.post('/gateway/api/oauth/callback',
        data: values, cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }

  Future<Map<String, dynamic>> gatewayOAuthPending(
      {CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/api/oauth/pending', cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> gatewaySettings(
      {CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/settings', cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> updateGatewaySettings(
    ...
    final response = await _dio.patch('/gateway/settings',
        data: values, cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> createGatewaySource(
    ...
    final response = await _dio.post('/gateway/api/sources',
        data: values, cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> updateGatewaySource(
    ...
    final response = await _dio.patch('/gateway/api/sources/$sourceId',
        data: values, cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }

  Future<void> deleteGatewaySource(String sourceId,
      {CancelToken? cancelToken}) async {
    await _dio.delete('/gateway/api/sources/$sourceId',
        cancelToken: cancelToken);
  }
  ...
  Future<Map<String, dynamic>> testGatewaySource(String sourceId,
      {String? projectId, CancelToken? cancelToken}) async {
    final response = await _dio.post(
  ...
  Future<Map<String, dynamic>> revokeGatewaySourceOAuth(String sourceId,
      {String? projectId, CancelToken? cancelToken}) async {
    final response = await _dio.post(
  ...
  Future<List<dynamic>> gatewaySessions({CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/api/sessions', cancelToken: cancelToken);
  ...
  Future<void> submitGatewayFeedback({
    ...
    await _dio.post('/gateway/api/feedback',
        data: {
          'session_id': sessionId,
  ...
  Future<List<dynamic>> gatewayWorkflows(
      {String? projectId, CancelToken? cancelToken}) async {
    final response = await _dio.get(
    ...
    if (data is Map<String, dynamic>) {
      return (data['data'] as List?) ??
          (data['workflows'] as List?) ??
          const [];
    }
    return data as List? ?? const [];
  }

  Future<Map<String, dynamic>> gatewayWorkflowPalette(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/workflows/palette/blocks',
        cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }

  Future<Map<String, dynamic>> gatewayPromptTemplates(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/workflows/prompt-templates',
        cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> gatewayWorkflowCanvas({
    ...
    final response = await _dio.get('/gateway/api/workflows/$draftId/canvas',
        cancelToken: cancelToken);
    final data = response.data as Map<String, dynamic>;
    return data['data'] as Map<String, dynamic>? ?? data;
  }
  ...
  Future<Map<String, dynamic>> deleteGatewayWorkflowWire({
    ...
    final response = await _dio.delete(
        '/gateway/api/workflows/$draftId/wires/$wireId',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> publishGatewayWorkflow(String draftId,
      {CancelToken? cancelToken}) async {
    final response = await _dio.post('/gateway/api/workflows/$draftId/publish',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> gatewayWorkflowRunState({
    ...
    final response = await _dio.get(
        '/gateway/api/workflows/$draftId/runs/$runId',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<bool> healthCheck() async {
    try {
      ...
      final isHealthy = data['status'] == 'ok' ||
          data['status'] == 'ready' ||
          data['status'] == 'healthy';
      RipLogger.success('healthCheck() status: $isHealthy',
          tag: 'RipClient_Endpoint');
      return isHealthy;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> executeAgent({
    ...
    final response = await _dio.post('/gateway/api/agent/execute',
        data: {
          'query': query,
  ...
  Future<Map<String, dynamic>> getAgentRun(String runId,
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/agent/runs/$runId',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> approveAgentTool({
    ...
    final response = await _dio.post('/gateway/api/agent/approve',
        data: {
          'run_id': runId,
          'approved': approved,
          if (comment != null) 'comment': comment,
  ...
  Future<Map<String, dynamic>> listAgentRuns({CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/api/agent/runs', cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getDashboard(String projectId,
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/agent/workspace/dashboard',
        queryParameters: {'project_id': projectId}, cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }

  Future<Map<String, dynamic>> listAgentTools(
      {CancelToken? cancelToken}) async {
    final response =
        await _dio.get('/gateway/api/agent/tools', cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }

  /// List available LLM configurations
  Future<Map<String, dynamic>> listLLMConfigs(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/workflows/llm-configs',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> addLLMConfig({
    ...
    final response = await _dio.post('/gateway/api/workflows/llm-configs',
        data: {
          'config_id': configId,
          'provider': provider,
          'model': model,
  ...
  Future<void> deleteLLMConfig(String configId,
      {CancelToken? cancelToken}) async {
    await _dio.delete('/gateway/api/workflows/llm-configs/$configId',
        cancelToken: cancelToken);
  }
  ...
  Future<void> setActiveProject(String projectId) async {
    try {
      await _dio.post('/gateway/api/projects/active',
  ...
  Future<void> clearActiveProject() async {
    try {
      await _dio
          .post('/gateway/api/projects/active', data: {'project_id': null});
    } catch (_) {}
  }

  /// List prompt templates (used by workflow builder)
  Future<Map<String, dynamic>> listGatewayPromptTemplates(
      {CancelToken? cancelToken}) async {
    final response = await _dio.get('/gateway/api/workflows/prompt-templates',
        cancelToken: cancelToken);
    return response.data as Map<String, dynamic>;
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Sandbox Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

  Future<Map<String, dynamic>> createSandbox(
      String projectId, String environment) async {
  ...
  Future<Map<String, dynamic>> listSandboxFiles(String sandboxId,
      {String path = '/workspace'}) async {
    final response = await _dio.get('/gateway/api/sandbox/$sandboxId/files',
  ...
  Future<Stream<Map<String, dynamic>>> contextStream(String task,
