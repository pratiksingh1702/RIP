...
class SourceRegistry:
    ...
    def dynamic_source_records(self, project_id: str | None = None) -> list[SourceRecord]:
        return [record for record in self._records.values() if record.enabled and record.kind == "mcp" and not record.protected and (project_id is None or record.project_id in {None, project_id})]
